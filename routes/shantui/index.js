...
/* Forklifts */
.get('/forklifts/sf20&sf25', (req,res) => {
    res.render('./products/shantui/forklifts/sf20-sf25')
})

.get('/forklifts/sf30&sf35', (req,res) => {
    res.render('./products/shantui/forklifts/sf30-sf35')
})

.get('/forklifts/sl60w-3', (req,res) => {
    res.render('./products/shantui/forklifts/sf50-sf60-sf70')
})
/* Forklifts END */
